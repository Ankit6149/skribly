...
const requiredReadmeClaims = [
  ...
  'Skribli hides the saved editor only after the latest draft is durable and returns it to the single **My Skribs** rail.',
...
const requiredCurrentDocumentation = [
  ...
  [componentInventory, 'Recoverable Archive', 'component inventory'],
