...
This directory contains the public Skribli product website. It uses plain HTML, CSS, JavaScript, and Vercel serverless routes so it remains independent from the Tauri desktop build.

## Current public state

Skribli is in **active production development**. Public installer delivery and checkout are disabled.
...
- No customer journey should send visitors to the source repository or a public release file.
...
Public configuration lives in `site/commerce-config.js`. Never place provider secrets or private release credentials in the site directory.
