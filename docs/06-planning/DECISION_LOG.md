...
| 2026-07-27 | Founder Alpha is Windows-only; macOS is deferred to a separately accepted platform baseline | Current |
| 2026-07-27 | Use a compact transient editor; do not ship the retired full-screen interactive overlay or persistent dots/tabs | Current |
| 2026-08-04 | A shortcut creates one note for zero matches and reopens the deterministic existing match | Current |
| 2026-08-04 | All Skribs is a normal non-floating recovery/library window opened from the tray | Current |
